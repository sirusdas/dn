=== NETRA Billing Manager ===
Contributors: webxarc.in
Donate link: http://webxarc.in/contribute/
...
= Website =
http://www.netrabilling.com/

= Documentation =
* [Getting Started](http://www.netrabilling.com/documentation/)
* [Support](http://www.netrabilling.com/support/)

= Bug Submission and Forum Support =
http://www.netrabilling.com/support/
...
1. Upload ‘netrabilling’ to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Click on the new menu item “NETRA Billing” and follow the fast-start directions.


== Frequently Asked Questions ==

= Q. I have a question =
A. You’re going to want to visit our website for documentation and support: http://www.netrabilling.com/documentation/
...
* 05/12/2015 - Fix date formatting for updated / added date
             - Added new filter:  apply_filters('nbm_get_config', $setting, $field);
             - usage: add_filter('nbm_get_config', 10, 2); // Two parameters, setting & field
             - added new filter: return apply_filters( 'nbm_check_permission', TRUE, $type, $inventory_item );
             - usage: add_filter('nbm_check_permission', 10, 3); // Three parameters, value, $type (edit_item or save_item), $inventory_item
             - added new filter: $args = apply_filters('nbm_query_item_args', $args);
             - usage: add_filter('nbm_query_item_args'); // The args are the only parameter
...
= 0.7.5	=
* 09/23/2014 - Fix bug with category name display, add nbm_use_currency_formats filter

= 0.7.4	=
* 09/17/2014 - Improved css classes, added class function netrabilling_label_class()
