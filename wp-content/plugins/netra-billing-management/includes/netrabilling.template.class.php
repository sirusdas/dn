 ...
 * from the plugin /view directory into your WP Theme directory inside a folder titled netrabilling/
 * 
 * @author Alpha Channel Group
 *
 */
class NBMTemplate extends NBMDB {
	 ...
	 *    1) child theme and
	 *    2) parent template will look in the netrabilling/views directory
	...
	public static function get($template) {
		...
		return apply_filters('netrabilling_template_' . $template, $file);
	}
}
