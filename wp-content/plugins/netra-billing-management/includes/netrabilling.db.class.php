...
class NBMDB extends NBMCore {
	...
	public function set_table_names() {
		global $table_prefix;
		$this->inventory_table = $table_prefix . 'netrabilling_item';
		$this->category_table  = $table_prefix . 'netrabilling_category';
		$this->image_table     = $table_prefix . 'netrabilling_image';
		$this->media_table     = $table_prefix . 'netrabilling_media';
		$this->status_table    = $table_prefix . 'netrabilling_status';
		$this->label_table     = $table_prefix . 'netrabilling_label';
	...
	private function check_tables() {
		...
		// Initial Install - set up tables my code i have commented this if so that able is created
	//	if ( ! (float) $inventory_version ) {
			...
			if ( ! in_array( $this->inventory_table, $tables ) ) {
				$sql = "CREATE TABLE IF NOT EXISTS `" . $this->inventory_table . "` (
                                        ...
                                        `frame_srno` int(11) DEFAULT NULL,
                                        `frame_name` varchar(255) DEFAULT NULL,
                                        `frame_qty` int(11) DEFAULT NULL,
                                        `lens1_srno` int(11) DEFAULT NULL,
                                        `lens1_name` varchar(255) DEFAULT NULL,
                                        `lens1_qty` int(11) DEFAULT NULL,
                                        `lens2_srno` int(11) DEFAULT NULL,
                                        `lens2_name` varchar(255) DEFAULT NULL,
                                        `lens2_qty` int(11) DEFAULT NULL,
                                        ...
                                        `sph_dist` int(11) DEFAULT NULL,
                                        `sph_near` int(11) DEFAULT NULL,
                                        `cyl_dist` int(11) DEFAULT NULL,
                                        `cyl_near` int(11) DEFAULT NULL,
                                        `axis_dist` int(11) DEFAULT NULL,
                                        `axis_near` int(11) DEFAULT NULL,
                                        `vn_dist` int(11) DEFAULT NULL,
                                        `vn_near` int(11) DEFAULT NULL,
                                        `order_status` int(1) DEFAULT NULL,
                                        `billing_description` mediumtext,
