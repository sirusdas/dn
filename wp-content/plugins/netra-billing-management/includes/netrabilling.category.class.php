...
class NBMCategory extends NBMDB {
	...
	*/
	...
	public function get_all($args = NULL) {
		...
		$args = apply_filters('nbm_get_categories_args', $args);
		...
		return apply_filters('nbm_get_categories', $categories, $args);
	} 
	...
	public function get_fields() {
		...
		return apply_filters('nbm_get_category_fields', $fields);
	}
	...
	public function get($category_id) {
		...
		return apply_filters('nbm_get_category', $category);
	}
	...
	public function save($data) {
		...
		$data = apply_filters('nbm_category_data_pre_save', $data);
		do_action('netrabilling_category_pre_save', $data);
		...
		do_action('netrabilling_category_post_save', $category_id, $data);
