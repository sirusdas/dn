...
?>
	<?php
    if($nbm_bill_id!=null){
      if($nbm_bill_id==netrabilling_get_the_ID()){
      //remeber before editing this please see the above conditions
        foreach($inventory_display AS $sort=>$field) { 
          // echo "<script type='text/javascript'>alert('".netrabilling_get_the_ID()."');</script>";            
            ...
            if($field=='mobile_no'){ $nbm_store[37]=netrabilling_the_field($field);}            
...
<div class="<?php  netrabilling_class(); ?>">   
                <table class="form-table">
                                <?php
                                if(netrabilling_get_the_ID()!=null){      ?>
				    <tr>       
                               
                                    <th class="label">Order No: </th>
                               
                                    <td><?php echo ''.netrabilling_get_the_ID(); ?></td>
                                        </tr>
                                <?php }  ?>                                       
				...
				<tr>       
                                ...
                                <?php
                                if($nbm_store[37]!=null){      ?>
				<tr>       
                             
                                    <th class="label">Mobile No</th>
                                <?php }  ?>
                                        <td><?php echo ''.$nbm_store[37]; ?></td>
...
<?php 
        ...
        foreach($inventory_display AS $sort=>$field) { 
          // echo "<script type='text/javascript'>alert('".netrabilling_the_field($field)."');</script>";            
            if($field=='inventory_id'){ $nbm_store[0]=netrabilling_the_field($field);}
            if($field=='inventory_date_updated'){ $nbm_store[1]=netrabilling_the_field($field);}
            if($field=='customer_name'){ $nbm_store[2]=netrabilling_the_field($field);}
            if($field=='customer_address'){ $nbm_store[3]=netrabilling_the_field($field);}
            if($field=='r'){ $nbm_store[4]=netrabilling_the_field($field);}
            if($field=='o'){ $nbm_store[5]=netrabilling_the_field($field);}
...
//////////////////////My experimental code//////////////////////////////////////////////////////////////////////////for date analysis///////////////////////////////////////////////////////            
          
      if($nbm_tr==1){   ?>
          <div class="<?php  netrabilling_class(); ?>">   
                <table class="form-table" class="nbm_spec">
                        <tr class="nbm_spec">
                               <th class="nbm_spec"> Date </th>
                               <th class="nbm_spec"> Order ID </th>
                               <th class="nbm_spec"> Customer Name </th>
                               <th class="nbm_spec"> Mobile No </th>
                               <th class="nbm_spec"> Total Amount </th>
                               <th class="nbm_spec"> Advance </th>
                               <th class="nbm_spec"> Balance </th>
                        </tr>
                                
                        <tr class="nbm_spec">

                                    <td class="nbm_spec"><?php echo ''.$nbm_store[1]; ?></td>

                                    <td class="nbm_spec"><?php echo ''.netrabilling_get_the_ID(); ?></td>                            
      
                                    <td class="nbm_spec"><?php echo ''.$nbm_store[2]; ?></td>

                                    <td class="nbm_spec"><?php echo ''.$nbm_store[37]; ?></td>
                                    
                                    <td class="nbm_spec"><?php echo ''.$nbm_store[17]; ?></td>
                                  
                                    <td class="nbm_spec"><?php echo ''.$nbm_store[18]; ?></td>                                  

                                    <td class="nbm_spec"><?php echo ''.$nbm_store[19]; ?></td>
                                   
                        </tr>
                </table>
              <?php $_SESSION["total"]=$total+$nbm_store[17]; ?>
              <?php $_SESSION["advance"]=$total+$nbm_store[18]; ?>
              <?php $_SESSION["balance"]=$total+$nbm_store[19]; ?>              
          </div>
 <?php }
  else{      
        ?>
