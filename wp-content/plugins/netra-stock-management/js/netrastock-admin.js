...
$("#addMore").click(function(){
    ...
    "<table class='form-table"+$c+"'>"+
				"<tbody><tr>"+
					"<th><label for='invoice_no"+$c+"'>Invoice No</label></th>"+
					"<td><input value='' class='regular-text' name='invoice_no"+$c+"'></td>"+
				"</tr>"+                              
				"<tr>"+
					"<th><label for='category_id"+$c+"'>Category</label></th>"+
					"<td><select name='category_id"+$c+"' id='category_id"+$c+"'>"+
...
"</td>"+
				"</tr>"+
                                					"<tr>"+
						"<th>Vendor Name</th>"+
						"<td><input value='' class='regular-text' name='vendor_name"+$c+"'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Date</th>"+
						"<td><input value='' class='MyDate' name='pdate"+$c+"' id='dp1458535185550'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Vendor Address</th>"+
						"<td><input value='' class='regular-text' name='vendor_address"+$c+"'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Product Name</th>"+
						"<td><input value='' class='regular-text' name='p_name"+$c+"'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Model No</th>"+
						"<td><input value='' class='regular-text' name='p_model_no"+$c+"'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Quantity</th>"+
						"<td><input value='' class='regular-text' name='p_qty"+$c+"'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Rate</th>"+
						"<td><input value='' class='regular-text' name='p_rate"+$c+"'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Total</th>"+
						"<td><input value='' class='regular-text' name='p_total"+$c+"'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Balance</th>"+
						"<td><input value='' class='regular-text' name='p_bal"+$c+"'></td>"+
					"</tr>"+
									"<tr>"+
						"<th>Due Date</th>"+
...
$('#form'+$c).submit(function(event) {
        ...
        var formData = {
            ...
            'superheroAlias'    : $('input[name=superheroAlias2]').val(),
