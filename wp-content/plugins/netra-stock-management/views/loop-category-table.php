...
if ( netrastock_have_items() ) { ?>
	<table
		class="netrastock_loop netrastock_loop_category netrastock_loop_category-<?php echo netrastock_get_the_category_ID(); ?>">
		<thead>
		<tr>
		...
		<?php while ( netrastock_have_items() ) {
			netrastock_the_item();
			netrastock_get_template_part( 'single-loop-category', 'table' );
		} ?>
		</tbody>
	</table>
	<?php
