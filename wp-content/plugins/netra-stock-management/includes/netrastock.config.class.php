...
class NSMConfig {
	...
	public function __construct() {
		self::$SETTINGS = NETRAstockInit::SETTINGS;
		self::$SETTINGS_GROUP = NETRAstockInit::SETTINGS_GROUP;
		self::loadConfig();
	}
	...
	public function get($field, $default = NULL) {
		...
		return apply_filters('NSM_get_config', $setting, $field);
	}
	...
	public static function defaults() {
		...
		return apply_filters('NSM_default_config', $defaults);
	}
}