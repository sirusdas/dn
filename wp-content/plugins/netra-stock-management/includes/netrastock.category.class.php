...
class NSMCategory extends NSMDB {
	...
	*/
	...
	public function get_all($args = NULL) {
		...
		$args = apply_filters('NSM_get_categories_args', $args);
		...
		return apply_filters('NSM_get_categories', $categories, $args);
	} 
	...
	public function get_fields() {
		...
		return apply_filters('NSM_get_category_fields', $fields);
	}
	...
	public function get($category_id) {
		...
		return apply_filters('NSM_get_category', $category);
	}
	...
	public function save($data) {
		...
		$data = apply_filters('NSM_category_data_pre_save', $data);
		do_action('netrastock_category_pre_save', $data);
		...
		do_action('netrastock_category_post_save', $category_id, $data);
