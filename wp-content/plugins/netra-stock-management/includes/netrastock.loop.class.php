...
class NSMLoop extends NSMCore {
	...
	public function __construct( $args = array() ) {
		...
		$this->item   = new NSMItem();
		$this->set_query_args( $args );
		$this->set_single();

		$this->use_currency_formats = array( 'price', 'amount', 'inventory_price', 'inventory_amount' );
		$this->use_currency_formats = apply_filters( 'NSM_use_currency_formats', $this->use_currency_formats );
		...
		$this->use_date_formats = apply_filters( 'NSM_use_date_formats', $this->use_date_formats );
	}
	...
	public function the_item() {
		...
		$netrastock_item = $this->current_item;
		$this->load_images();
		$this->load_media();
	}
