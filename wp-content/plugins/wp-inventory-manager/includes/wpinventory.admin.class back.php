	...
	public static function edit_item( $inventory_id = NULL ) {
		...
		<form method="post" action="<?php echo self::$self_url; ?>">
            ...
            <table>
                ...
                <tr>
                     <th><label for="order_no"><?php self::label( 'order_no' ); ?></label></th>
                     <td><input name="order_no" class="regular-text order_no"
					           value="<?php echo esc_attr( $order_no ); ?>" readonly /></td>                   
                    <th><label for="d_date"><?php self::label( 'd_date' ); ?></label></th>
                    <td><input name="d_date" class="MyDate d_date" 
					           value="<?php echo esc_attr( $d_date ); ?>"/></td>                    
                </tr>
                <tr>
                ...
                <tr>
                    <th><label for="c_no"><?php self::label( 'c_no' ); ?></label></th>
                    <td><input name="c_no" class="regular-text c_no onfocusCS" id="c_no" 
					           value="<?php echo esc_attr( $c_no ); ?>"/></td>
                    <th><label for="date"><?php self::label( 'date' ); ?></label></th>
                    <td><input name="date" class="MyDate date"  
					           value="<?php echo esc_attr( $date ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="c_fname"><?php self::label( 'c_fname' ); ?></label></th>
                    <td><input name="c_fname" class="regular-text c_fname  onfocusCS" id="c_fname" 
					           value="<?php echo esc_attr( $c_fname ); ?>"/></td>
                    <th><label for="c_lname"><?php self::label( 'c_lname' ); ?></label></th>
                    <td><input name="c_lname" class="regular-text c_lname onfocusCS" id="c_lname" 
					           value="<?php echo esc_attr( $c_lname ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="c_gender"><?php self::label( 'c_gender' ); ?></label></th>
		        <td><select name="c_gender">
                   ...
                   <!-- <td><input name="c_gender" class="regular-text"
					           value="<?php// echo esc_attr( $c_gender ); ?>"/></td> -->
                </tr>

                <tr>
                    <th><label for="c_add"><?php self::label( 'c_add' ); ?></label></th>
                    <td><input name="c_add" class="regular-text c_add" id="c_add"
					           value="<?php echo esc_attr( $c_add ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="c_city"><?php self::label( 'c_city' ); ?></label></th>
                    <td><input name="c_city" class="regular-text c_city onfocusCS"  id="c_city" 
					           value="<?php echo esc_attr( $c_city ); ?>"/></td>
                    <th><label for="c_city_pin"><?php self::label( 'c_city_pin' ); ?></label></th>
                    <td><input name="c_city_pin" class="regular-text c_city_pin onfocusCS" id="c_city_pin"
					           value="<?php echo esc_attr( $c_city_pin ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="c_email"><?php self::label( 'c_email' ); ?></label></th>
                    <td><input name="c_email" class="regular-text c_email onfocusCS" id="c_email" 
					           value="<?php echo esc_attr( $c_email ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="c_birth"><?php self::label( 'c_birth' ); ?></label></th>
                    <td><input name="c_birth" class="MyDate c_birth" 
					           value="<?php echo esc_attr( $c_birth ); ?>"/></td>
                    <th><label for="c_anni"><?php self::label( 'c_anni' ); ?></label></th>
                    <td><input name="c_anni" class="MyDate c_anni onfocusCS" 
					           value="<?php echo esc_attr( $c_anni ); ?>"/></td>
                </tr>                
                
            </table> 
        </section>
    
    <section id="orderProfile">
              No of Frame:-
                <input id="nofFrame" class="small-text" oninput="myFunctionFrame()">
            <table class="frame_t1">
                <caption>Frame1</caption>
                <tr>
                    <th><label for="f_brand0"><?php self::label( 'f_brand0' ); ?></label></th>
                    <td><div class="ui-widget"><input name="f_brand0" class="regular-text onfocus" id="f_brand0"
					           value="<?php echo esc_attr( $f_brand0 ); ?>"/></div></td>
                    <th><label for="f_model0"><?php self::label( 'f_model0' ); ?></label></th>
                    <td><div class="ui-widget"><input name="f_model0" class="regular-text onfocus" id="skills" 
                                                      value="<?php echo esc_attr( $f_model0 ); ?>"/></div></td>
                     <th><label for="f_rate0">Rate</label></th>
                     <td><div class="f_rate0"><select name="f_rate0" class="small-text onfocus" id="vrate" />
                             <option  value="<?php echo $f_rate0;  ?>"><?php echo $f_rate0 ?></option>
                             </select></div></td>
                </tr>
                
                <tr>
                    <th><label for="f_size0"><?php self::label( 'f_size0' ); ?></label></th>
                    <td><input name="f_size0" class="regular-text"
					           value="<?php echo esc_attr( $f_size0 ); ?>"/></td>
                    <th><label for="f_color0"><?php self::label( 'f_color0' ); ?></label></th>
                    <td><input name="f_color0" class="regular-text"
					           value="<?php echo esc_attr( $f_color0 ); ?>"/></td>
                </tr>
            </table>
        

        <table class="frame_t2">
                <caption>Frame2</caption>
                <tr>
                    <th><label for="f_brand1">Company</label></th>
                    <td><div class="ui-widget"><input name="f_brand1" class="regular-text" id="f_brand1"
					           value="<?php echo esc_attr( $f_brand1 ); ?>"/></div></td>
                    <th><label for="f_model1"><?php self::label( 'f_model1' ); ?></label></th>
                    <td><input name="f_model1" class="regular-text" id="frame2_model" oninput="myFunction()" 
					           value="<?php echo esc_attr( $f_model1 ); ?>"/></td>                    
                </tr>
                
                <tr>
                    <th><label for="f_size1"><?php self::label( 'f_size1' ); ?></label></th>
                    <td><input name="f_size1" class="regular-text"
					           value="<?php echo esc_attr( $f_size1 ); ?>"/></td>
                    <th><label for="f_color1"><?php self::label( 'f_color1' ); ?></label></th>
                    <td><input name="f_color1" class="regular-text"
					           value="<?php echo esc_attr( $f_color1 ); ?>"/></td>
                </tr>
            </table>
        

        <table class="frame_t3">
                <caption>Frame3</caption>
                <tr>
                    <th><label for="f_brand2">Company</label></th>
                    <td><div class="ui-widget"><input name="f_brand2" class="regular-text" id="f_brand2"
					           value="<?php echo esc_attr( $f_brand2); ?>"/></div></td>
                    <th><label for="f_model2"><?php self::label( 'f_model2' ); ?></label></th>
                    <td><input name="f_model2" class="regular-text" id="frame3_model" oninput="myFunction()" 
					           value="<?php echo esc_attr( $f_model2 ); ?>"/></td>                    
                </tr>
                
                <tr>
                    <th><label for="f_size2"><?php self::label( 'f_size2' ); ?></label></th>
                    <td><input name="f_size2" class="regular-text"
					           value="<?php echo esc_attr( $f_size2 ); ?>"/></td>
                    <th><label for="f_color2"><?php self::label( 'f_color2' ); ?></label></th>
                    <td><input name="f_color2" class="regular-text"
					           value="<?php echo esc_attr( $f_color2 ); ?>"/></td>
                </tr>
            </table>
        

        <table class="frame_t4">
                <caption>Frame4</caption>
                <tr>
                    <th><label for="f_brand3">Company</label></th>
                    <td><div class="ui-widget"><input name="f_brand3" class="regular-text" id="f_brand3"
					           value="<?php echo esc_attr( $f_brand3 ); ?>"/></div></td>
                    <th><label for="f_model3"><?php self::label( 'f_model3' ); ?></label></th>
                    <td><input name="f_model3" class="regular-text" id="frame4_model" oninput="myFunction()" 
					           value="<?php echo esc_attr( $f_model3 ); ?>"/></td>                    
                </tr>
                
                <tr>
                    <th><label for="f_size3"><?php self::label( 'f_size3' ); ?></label></th>
                    <td><input name="f_size3" class="regular-text"
					           value="<?php echo esc_attr( $f_size3 ); ?>"/></td>
                    <th><label for="f_color3"><?php self::label( 'f_color3' ); ?></label></th>
                    <td><input name="f_color3" class="regular-text"
					           value="<?php echo esc_attr( $f_color3 ); ?>"/></td>
                </tr>
            </table>
        

        <table class="frame_t5">
                <caption>Frame5</caption>
                <tr>
                    <th><label for="f_brand4">Company</label></th>
                    <td><div class="ui-widget"><input name="f_brand4" class="regular-text" id="f_brand4"
					           value="<?php echo esc_attr( $f_brand4 ); ?>"/></div></td>
                    <th><label for="f_model4"><?php self::label( 'f_model4' ); ?></label></th>
                    <td><input name="f_model4" class="regular-text" id="frame5_model" oninput="myFunction()" 
					           value="<?php echo esc_attr( $f_model4 ); ?>"/></td>                    
                </tr>
                
                <tr>
                    <th><label for="f_size4"><?php self::label( 'f_size4' ); ?></label></th>
                    <td><input name="f_size4" class="regular-text"
					           value="<?php echo esc_attr( $f_size4 ); ?>"/></td>
                    <th><label for="f_color4"><?php self::label( 'f_color4' ); ?></label></th>
                    <td><input name="f_color4" class="regular-text"
					           value="<?php echo esc_attr( $f_color4 ); ?>"/></td>
                </tr>
            </table>
         
        
        <table class="lens_t1">
                <caption>Lens1</caption>
                <tr>

                    <th><label for="r0"><?php self::label( 'r0' ); ?></label></th>
                    <td><input name="r0" class="regular-text"
					           value="<?php echo esc_attr( $r0 ); ?>"/></td>

                    <th><label for="r_size0"><?php self::label( 'r_size0' ); ?></label></th>
                    <td><input name="r_size0" class="regular-text"
					           value="<?php echo esc_attr( $r_size0 ); ?>"/></td>

                    <th><label for="r_tint0"><?php self::label( 'r_tint0' ); ?></label></th>
                    <td><input name="r_tint0" class="regular-text"
					           value="<?php echo esc_attr( $r_tint0 ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="l0"><?php self::label( 'l0' ); ?></label></th>
                    <td><input name="l0" class="regular-text"
					           value="<?php echo esc_attr( $l0 ); ?>"/></td>

                    <th><label for="l_size0"><?php self::label( 'l_size0' ); ?></label></th>
                    <td><input name="l_size0" class="regular-text"
					           value="<?php echo esc_attr( $l_size0 ); ?>"/></td>

                    <th><label for="l_tint0"><?php self::label( 'l_tint0' ); ?></label></th>
                    <td><input name="l_tint0" class="regular-text"
					           value="<?php echo esc_attr( $l_tint0 ); ?>"/></td>
                </tr>
                
                <tr>

                                        <th><label for="spec0"><?php self::label( 'spec0' ); ?></label></th>
                    <td><input name="spec0" class="regular-text"
					           value="<?php echo esc_attr( $spec0 ); ?>"/></td>

                                        <th><label for="note0"><?php self::label( 'note0' ); ?></label></th>
                    <td><input name="note0" class="regular-text"
					           value="<?php echo esc_attr( $note0 ); ?>"/></td>
                </tr>
        ...
        <table class="lens_t2">
                <caption>Lens2</caption>
                <tr>

                    <th><label for="r1"><?php self::label( 'r1' ); ?></label></th>
                    <td><input name="r1" class="regular-text"
					           value="<?php echo esc_attr( $r1 ); ?>"/></td>

                    <th><label for="r_size1"><?php self::label( 'r_size1' ); ?></label></th>
                    <td><input name="r_size1" class="regular-text"
					           value="<?php echo esc_attr( $r_size1 ); ?>"/></td>

                    <th><label for="r_tint1"><?php self::label( 'r_tint1' ); ?></label></th>
                    <td><input name="r_tint1" class="regular-text"
					           value="<?php echo esc_attr( $r_tint1 ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="l1"><?php self::label( 'l1' ); ?></label></th>
                    <td><input name="l1" class="regular-text"
					           value="<?php echo esc_attr( $l1 ); ?>"/></td>

                    <th><label for="l_size1"><?php self::label( 'l_size1' ); ?></label></th>
                    <td><input name="l_size1" class="regular-text"
					           value="<?php echo esc_attr( $l_size1 ); ?>"/></td>

                    <th><label for="l_tint1"><?php self::label( 'l_tint1' ); ?></label></th>
                    <td><input name="l_tint1" class="regular-text"
					           value="<?php echo esc_attr( $l_tint1 ); ?>"/></td>
                </tr>
                
                <tr>

                                        <th><label for="spec"><?php self::label( 'spec1' ); ?></label></th>
                    <td><input name="spec1" class="regular-text"
					           value="<?php echo esc_attr( $spec1 ); ?>"/></td>

                                        <th><label for="note"><?php self::label( 'note1' ); ?></label></th>
                    <td><input name="note1" class="regular-text"
					           value="<?php echo esc_attr( $note1 ); ?>"/></td>
                </tr>
        ...
        <table class="lens_t3">
                <caption>Lens3</caption>
                                <tr>

                    <th><label for="r2"><?php self::label( 'r2' ); ?></label></th>
                    <td><input name="r2" class="regular-text"
					           value="<?php echo esc_attr( $r2 ); ?>"/></td>

                    <th><label for="r_size2"><?php self::label( 'r_size2' ); ?></label></th>
                    <td><input name="r_size2" class="regular-text"
					           value="<?php echo esc_attr( $r_size2 ); ?>"/></td>

                    <th><label for="r_tint2"><?php self::label( 'r_tint2' ); ?></label></th>
                    <td><input name="r_tint2" class="regular-text"
					           value="<?php echo esc_attr( $r_tint2 ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="l2"><?php self::label( 'l2' ); ?></label></th>
                    <td><input name="l2" class="regular-text"
					           value="<?php echo esc_attr( $l2 ); ?>"/></td>

                    <th><label for="l_size2"><?php self::label( 'l_size2' ); ?></label></th>
                    <td><input name="l_size2" class="regular-text"
					           value="<?php echo esc_attr( $l_size2 ); ?>"/></td>

                    <th><label for="l_tint2"><?php self::label( 'l_tint2' ); ?></label></th>
                    <td><input name="l_tint2" class="regular-text"
					           value="<?php echo esc_attr( $l_tint2 ); ?>"/></td>
                </tr>
                
                <tr>

                                        <th><label for="spec"><?php self::label( 'spec2' ); ?></label></th>
                    <td><input name="spec2" class="regular-text"
					           value="<?php echo esc_attr( $spec2 ); ?>"/></td>

                                        <th><label for="note"><?php self::label( 'note2' ); ?></label></th>
                    <td><input name="note2" class="regular-text"
					           value="<?php echo esc_attr( $note2 ); ?>"/></td>
                </tr>
        ...
        <table class="lens_t4">
                <caption>Lens4</caption>
                                <tr>

                    <th><label for="r3"><?php self::label( 'r3' ); ?></label></th>
                    <td><input name="r3" class="regular-text"
					           value="<?php echo esc_attr( $r3 ); ?>"/></td>

                    <th><label for="r_size3"><?php self::label( 'r_size3' ); ?></label></th>
                    <td><input name="r_size3" class="regular-text"
					           value="<?php echo esc_attr( $r_size3 ); ?>"/></td>

                    <th><label for="r_tint3"><?php self::label( 'r_tint3' ); ?></label></th>
                    <td><input name="r_tint3" class="regular-text"
					           value="<?php echo esc_attr( $r_tint3 ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="l3"><?php self::label( 'l3' ); ?></label></th>
                    <td><input name="l3" class="regular-text"
					           value="<?php echo esc_attr( $l3 ); ?>"/></td>

                    <th><label for="l_size3"><?php self::label( 'l_size3' ); ?></label></th>
                    <td><input name="l_size3" class="regular-text"
					           value="<?php echo esc_attr( $l_size3 ); ?>"/></td>

                    <th><label for="l_tint3"><?php self::label( 'l_tint3' ); ?></label></th>
                    <td><input name="l_tint3" class="regular-text"
					           value="<?php echo esc_attr( $l_tint3 ); ?>"/></td>
                </tr>
                
                <tr>

                                        <th><label for="spec"><?php self::label( 'spec3' ); ?></label></th>
                    <td><input name="spec3" class="regular-text"
					           value="<?php echo esc_attr( $spec3 ); ?>"/></td>

                                        <th><label for="note"><?php self::label( 'note3' ); ?></label></th>
                    <td><input name="note3" class="regular-text"
					           value="<?php echo esc_attr( $note3 ); ?>"/></td>
                </tr>
        ...
        <table class="lens_t5">
                <caption>Lens5</caption>
                                <tr>

                    <th><label for="r4"><?php self::label( 'r4' ); ?></label></th>
                    <td><input name="r4" class="regular-text"
					           value="<?php echo esc_attr( $r4 ); ?>"/></td>

                    <th><label for="r_size4"><?php self::label( 'r_size4' ); ?></label></th>
                    <td><input name="r_size4" class="regular-text"
					           value="<?php echo esc_attr( $r_size4 ); ?>"/></td>

                    <th><label for="r_tint4"><?php self::label( 'r_tint4' ); ?></label></th>
                    <td><input name="r_tint4" class="regular-text"
					           value="<?php echo esc_attr( $r_tint4 ); ?>"/></td>
                </tr>
                
                <tr>
                    <th><label for="l4"><?php self::label( 'l4' ); ?></label></th>
                    <td><input name="l4" class="regular-text"
					           value="<?php echo esc_attr( $l4 ); ?>"/></td>

                    <th><label for="l_size4"><?php self::label( 'l_size4' ); ?></label></th>
                    <td><input name="l_size4" class="regular-text"
					           value="<?php echo esc_attr( $l_size4 ); ?>"/></td>

                    <th><label for="l_tint4"><?php self::label( 'l_tint4' ); ?></label></th>
                    <td><input name="l_tint4" class="regular-text"
					           value="<?php echo esc_attr( $l_tint4 ); ?>"/></td>
                </tr>
                
                <tr>

                                        <th><label for="spec"><?php self::label( 'spec4' ); ?></label></th>
                    <td><input name="spec4" class="regular-text"
					           value="<?php echo esc_attr( $spec4 ); ?>"/></td>

                                        <th><label for="note"><?php self::label( 'note4' ); ?></label></th>
                    <td><input name="note4" class="regular-text"
					           value="<?php echo esc_attr( $note4 ); ?>"/></td>
                </tr>
    ...
    <section id="accounts">
        <table>
            <caption>Account Profile</caption>
                <tr>
                    <th><label for="f_sp0"><?php self::label( 'f_sp0' ); ?></label></th>
                    <td><input name="f_sp0" id="f_sp0" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $f_sp0 ); ?>"/></td>

                <th><label for="l_sp0"><?php self::label( 'l_sp0' ); ?></label></th>
                    <td><input name="l_sp0" id="l_sp0" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $l_sp0 ); ?>"/></td>
                </tr>
                <tr class="acc_f2">
                    <th><label for="f_sp1"><?php self::label( 'f_sp1' ); ?></label></th>
                    <td><input name="f_sp1" id="f_sp1" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $f_sp1 ); ?>"/></td>

                <th><label for="l_sp1"><?php self::label( 'l_sp1' ); ?></label></th>
                    <td><input name="l_sp1" id="l_sp1" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $l_sp1 ); ?>"/></td>                   
                </tr>
                <tr class="acc_f3">
                    <th><label for="f_sp2"><?php self::label( 'f_sp2' ); ?></label></th>
                    <td><input name="f_sp2" id="f_sp2" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $f_sp2 ); ?>"/></td>

                <th><label for="l_sp2"><?php self::label( 'l_sp2' ); ?></label></th>
                    <td><input name="l_sp2" id="l_sp2" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $l_sp2 ); ?>"/></td>                   
                </tr>
                <tr class="acc_f4">
                    <th><label for="f_sp3"><?php self::label( 'f_sp3' ); ?></label></th>
                    <td><input name="f_sp3" id="f_sp3" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $f_sp3 ); ?>"/></td>

                <th><label for="l_sp3"><?php self::label( 'l_sp3' ); ?></label></th>
                    <td><input name="l_sp3" id="l_sp3" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $l_sp3 ); ?>"/></td>                  
                </tr>
                <tr class="acc_f5">
                    <th><label for="f_sp4"><?php self::label( 'f_sp4' ); ?></label></th>
                    <td><input name="f_sp4" id="f_sp4" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $f_sp4 ); ?>"/></td>

                <th><label for="l_sp4"><?php self::label( 'l_sp4' ); ?></label></th>
                    <td><input name="l_sp4" id="l_sp4" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $l_sp4 ); ?>"/></td>                  
                </tr>
                
                <tr>

                    <th><label for="others"><?php self::label( 'others' ); ?></label></th>
                    <td><input name="others" id="others" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $others ); ?>"/></td>

                    <th><label for="adj"><?php self::label( 'adj' ); ?></label></th>
                    <td><input name="adj" id="adj" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $adj ); ?>"/></td>
                </tr>
                <tr>
                    <th><label for="total"><?php self::label( 'total' ); ?></label></th>
                    <td><input name="total" id="total" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $total ); ?>"/></td>
                    <th><label for="adv"><?php self::label( 'adv' ); ?></label></th>
                    <td><input name="adv" id="adv" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $adv ); ?>"/></td>
                </tr> 
                <tr>
                    <th><label for="bal"><?php self::label( 'bal' ); ?></label></th>
                    <td><input name="bal" id="bal" class="regular-text" oninput="calCustData()"
					           value="<?php echo esc_attr( $bal ); ?>"/></td>

                    <th><label for="status"><?php self::label( 'status' ); ?></label></th>
