...
/*
 * This is a backup which contains code for status change from Deliverd to Pending and Stock updates are dont Automatically.
 * Very Tricky codes and hence must be preserved
 * 
 */
if ( ! defined('ABSPATH')) {
	exit;
