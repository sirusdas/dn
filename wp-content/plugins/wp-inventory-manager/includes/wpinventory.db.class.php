...
class WPIMDB extends WPIMCore {
	...
	/**
	 * Name of stock table.  Stores category names.
	 * @var string
	 */
	...
	public function set_table_names() {
		...
		$this->label_table     = $table_prefix . 'wpinventory_label';
                $this->stock_table     = $table_prefix . 'wpinventory_stock';
                $this->frame_table     = $table_prefix . 'wpinventory_frame';
                $this->lens_table     = $table_prefix . 'wpinventory_lens';
