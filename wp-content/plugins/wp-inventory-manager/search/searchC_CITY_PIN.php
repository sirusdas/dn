...
$link = '%' . $link . '%';
   ...
   // $table_name = $wpdb->prefix . 'wpinventory_stock';
    $categories = $wpdb->get_results('SELECT Distinct c_city_pin FROM wp_wpinventory_item WHERE c_city_pin LIKE "' . $link . '"' . $where .' ORDER BY c_city_pin ASC ');
