<?php extract($args); ?>
<form id="ncm_reserve" name="netracustomer_reserve" method="post" action="#ncm_reserve" class="netracustomer_reserve">
	<?php if ($form_title) { ?>
	...
	<?php if ($display_name) {
		...
		<div class="name<?php echo $required; ?>">
			...
			<input type="text" name="netracustomer_reserve_name" value="<?php echo $name; ?>"<?php echo $required; ?> />
		</div>
	<?php } ?>
	<?php if ($display_address) {
		...
		<div class="address<?php echo $required; ?>">
			...
			<input type="text" name="netracustomer_reserve_address" value="<?php echo $address; ?>"<?php echo $required; ?> />
		</div>
	<?php } ?>
	<?php if ($display_city) {
		...
		<div class="city"<?php echo $required; ?>>
			...
			<input type="text" name="netracustomer_reserve_city" value="<?php echo $city; ?>"<?php echo $required; ?> />
		</div>
	<?php } ?>
	<?php if ($display_state) {
		...
		<div class="state"<?php echo $required; ?>>
			...
			<input type="text" name="netracustomer_reserve_state" value="<?php echo $state; ?>"<?php echo $required; ?> />
		</div>
	<?php } ?>
	<?php if ($display_zip) {
		...
		<div class="zip"<?php echo $required; ?>>
			...
			<input type="text" name="netracustomer_reserve_zip" value="<?php echo $zip; ?>"<?php echo $required; ?> />
		</div>
	<?php } ?>
	<?php if ($display_phone) {
		...
		<div class="phone"<?php echo $required; ?>>
			...
			<input type="text" name="netracustomer_reserve_phone" value="<?php echo $phone; ?>"<?php echo $required; ?> />
		</div>
	<?php } ?>
	<?php if ($display_email) {
		...
		<div class="email"<?php echo $required; ?>>
			...
			<input type="text" name="netracustomer_reserve_email" value="<?php echo $email; ?>"<?php echo $required; ?> />
		</div>
	<?php } ?>
	<?php if ($display_quantity) {
		...
		<div class="quantity"<?php echo $required; ?>>
			...
			<input type="text" name="netracustomer_reserve_quantity" value="<?php echo $quantity; ?>"<?php echo $required; ?> />
		</div>
	<?php } ?>
	<?php if ($display_message) {
		...
		<div class="message"<?php echo $required; ?>>
			...
			<textarea name="netracustomer_reserve_message"<?php echo $required; ?>><?php echo $message; ?></textarea>
		</div>
	<?php } ?>
	<div class="submit">
		<input type="submit" name="netracustomer_reserve_submit" value="<?php echo $submit_label; ?>" />
	</div>
</form>