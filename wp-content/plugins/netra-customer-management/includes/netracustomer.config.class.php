...
class NCMConfig {
	...
	public function __construct() {
		self::$SETTINGS = NETRACustomerInit::SETTINGS;
		self::$SETTINGS_GROUP = NETRACustomerInit::SETTINGS_GROUP;
		self::loadConfig();
	}
	...
	public function get($field, $default = NULL) {
		...
		return apply_filters('ncm_get_config', $setting, $field);
	}
	...
	public static function defaults() {
		...
		return apply_filters('ncm_default_config', $defaults);
	}
}