...
class NCMLoop extends NCMCore {
	...
	public function __construct( $args = array() ) {
		...
		$this->item   = new NCMItem();
		$this->set_query_args( $args );
		$this->set_single();

		$this->use_currency_formats = array( 'price', 'amount', 'inventory_price', 'inventory_amount' );
		$this->use_currency_formats = apply_filters( 'ncm_use_currency_formats', $this->use_currency_formats );
		...
		$this->use_date_formats = apply_filters( 'ncm_use_date_formats', $this->use_date_formats );
	}
	...
	public function the_item() {
		...
		$netracustomer_item = $this->current_item;
		$this->load_images();
		$this->load_media();
	}
	...
	public function get_username( $user_id ) {
		...
		return $this->users[ $user_id ]->user_nicename;
	}
