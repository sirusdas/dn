 ...
 * from the plugin /view directory into your WP Theme directory inside a folder titled netracustomer/
 * 
 * @author Alpha Channel Group
 *
 */
class NCMTemplate extends NCMDB {
	 ...
	 *    1) child theme and
	 *    2) parent template will look in the netracustomer/views directory
	...
	public static function get($template) {
		...
		return apply_filters('netracustomer_template_' . $template, $file);
	}
}
