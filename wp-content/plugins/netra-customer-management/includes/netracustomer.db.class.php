...
class NCMDB extends NCMCore {
	...
	public function set_table_names() {
		global $table_prefix;
                $this->stock_table = $table_prefix . 'netrastock_item';
		$this->inventory_table = $table_prefix . 'netracustomer_item';
		$this->category_table  = $table_prefix . 'netracustomer_category';
		$this->image_table     = $table_prefix . 'netracustomer_image';
		$this->media_table     = $table_prefix . 'netracustomer_media';
		$this->status_table    = $table_prefix . 'netracustomer_status';
		$this->label_table     = $table_prefix . 'netracustomer_label';
