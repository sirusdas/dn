...
class NCMCategory extends NCMDB {
	...
	*/
	...
	public function get_all($args = NULL) {
		...
		$args = apply_filters('ncm_get_categories_args', $args);
		...
		return apply_filters('ncm_get_categories', $categories, $args);
	} 
	...
	public function get_fields() {
		...
		return apply_filters('ncm_get_category_fields', $fields);
	}
	...
	public function get($category_id) {
		...
		return apply_filters('ncm_get_category', $category);
	}
	...
	public function save($data) {
		...
		$data = apply_filters('ncm_category_data_pre_save', $data);
		do_action('netracustomer_category_pre_save', $data);
		...
		do_action('netracustomer_category_post_save', $category_id, $data);
	...
	public function dropdown($name, $selected, $class = '') {
		...
		$select = '<select id="category_id" name="' . $name . '"';
