...
= Website =
http://www.netracustomer.com/

= Documentation =
* [Getting Started](http://webxarc.in/documentation/)
* [Support](http://webxarc.in/support/)

= Bug Submission and Forum Support =
http://www.webxarc.in/support/
...
1. Upload ‘netracusotmer’ to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Click on the new menu item “NETRA Customer” and follow the fast-start directions.


== Frequently Asked Questions ==

= Q. I have a question =
A. You’re going to want to visit our website for documentation and support: http://www.webxarc.in/documentation/
...
* 05/12/2015 - Fix date formatting for updated / added date
             - Added new filter:  apply_filters('ncm_get_config', $setting, $field);
             - usage: add_filter('ncm_get_config', 10, 2); // Two parameters, setting & field
             - added new filter: return apply_filters( 'ncm_check_permission', TRUE, $type, $inventory_item );
             - usage: add_filter('ncm_check_permission', 10, 3); // Three parameters, value, $type (edit_item or save_item), $inventory_item
             - added new filter: $args = apply_filters('ncm_query_item_args', $args);
             - usage: add_filter('ncm_query_item_args'); // The args are the only parameter
...
= 0.7.5	=
* 09/23/2014 - Fix bug with category name display, add ncm_use_currency_formats filter

= 0.7.4	=
* 09/17/2014 - Improved css classes, added class function netracustomer_label_class()
